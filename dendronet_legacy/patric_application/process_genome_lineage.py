...
def create_labelled_tree(data_file='genome_lineage', labels_file='clostridium_samples_combined_resistance.csv'):
    ...
    # todo: this fails for some of the firmicutes, why?
    # assert (len(ids.intersection(label_ids)) == len(label_ids)), 'Not all labelled samples accounted for in the lineage'
