...
if __name__ == '__main__':
    ...
    parser.add_argument('--seed', type=int, default=[0, 1, 2, 3], metavar='S',
    ...
    parser.add_argument('--output-dir', type=str, default='torch_betalactam', metavar='O',
    ...
    parser.add_argument('--tree-folder', type=str, default='patric_application/patric_tree_storage/betalactam', metavar='T',
                        help='folder to look in for a stored tree structure')
    parser.add_argument('--label-file', type=str, default='betalactam_firmicutes_samples.csv', metavar='LF',
